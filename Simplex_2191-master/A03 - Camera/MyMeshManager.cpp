...
int MyMeshManager::GenerateCube(vector3 a_fSize, vector3 origin, vector3 a_v3Color)
{
	MyMesh* pMesh = new MyMesh();
	pMesh->GenerateCube(a_fSize, origin, a_v3Color);
