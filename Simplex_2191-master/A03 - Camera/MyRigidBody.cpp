...
void MyRigidBody::SetModelMatrix(matrix4 a_m4ModelMatrix)
{
	...
	//your code goes here---------------------
	vector<vector3> rigidBodyPoints;

	rigidBodyPoints.push_back(m_v3MaxL);
	rigidBodyPoints.push_back(vector3(m_v3MinL.x, m_v3MaxL.y, m_v3MaxL.z));
	rigidBodyPoints.push_back(vector3(m_v3MinL.x, m_v3MinL.y, m_v3MaxL.z));
	rigidBodyPoints.push_back(vector3(m_v3MaxL.x, m_v3MinL.y, m_v3MaxL.z));
	rigidBodyPoints.push_back(vector3(m_v3MaxL.x, m_v3MaxL.y, m_v3MinL.z));
	rigidBodyPoints.push_back(vector3(m_v3MinL.x, m_v3MaxL.y, m_v3MinL.z));
	rigidBodyPoints.push_back(m_v3MinL);
	rigidBodyPoints.push_back(vector3(m_v3MaxL.x, m_v3MinL.y, m_v3MinL.z));

	for (int i = 0; i < rigidBodyPoints.size(); i++) 
	{
		vector4 rotatedMatrix = m_m4ToWorld * vector4(rigidBodyPoints[i], 1);
		rigidBodyPoints[i] = (vector3)(rotatedMatrix);
	}

	vector<vector3> minMax = GetMaxAndMinValues(rigidBodyPoints);

	m_v3MinG = minMax.at(0);
	m_v3MaxG = minMax.at(1);
...
vector<vector3> MyRigidBody::GetMaxAndMinValues(vector<vector3> points)
{
	//Initial Values
	...
	//Package & Return
	vector<vector3> minAndMaxVectors;
	minAndMaxVectors.push_back(min);
	minAndMaxVectors.push_back(max);

	return minAndMaxVectors;
}
