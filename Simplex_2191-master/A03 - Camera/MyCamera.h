...
public:
	...
	*/
	...
	OUTPUT: ---
	*/
	void MoveLeft(float a_fDistance = 0.1f);
	...
	OUTPUT: ---
	*/
	void MoveUp(float a_fDistance = 0.1f);
	...
	OUTPUT: ---
	*/
	void RotateLeft(float a_fDistance = 0.1f);
	...
	OUTPUT: ---
	*/
	void RotateDown(float a_fDistance = 0.1f);

	/*
	USAGE: Updates the current forward Transform
	OUTPUT: ---
	*/
	void UpdateForward();
};
