...
void MyMesh::GenerateCube(vector3 a_fSize, vector3 origin, vector3 a_v3Color)
{
	if (a_fSize.x < 0.01f)
		a_fSize.x = 0.01f;
	if (a_fSize.y < 0.01f)
	...
	vector3 fValue = a_fSize * 0.5f;
	//3--2
	//|  |
	//0--1

	vector3 point0(-fValue.x + origin.x, -fValue.y + origin.y, fValue.z + origin.z); //0
	vector3 point1(fValue.x + origin.x, -fValue.y + origin.y, fValue.z + origin.z); //1
	vector3 point2(fValue.x + origin.x, fValue.y + origin.y, fValue.z + origin.z); //2
	vector3 point3(-fValue.x + origin.x, fValue.y + origin.y, fValue.z + origin.z); //3

	vector3 point4(-fValue.x + origin.x, -fValue.y + origin.y, -fValue.z + origin.z); //4
	vector3 point5(fValue.x + origin.x, -fValue.y + origin.y, -fValue.z + origin.z); //5
	vector3 point6(fValue.x + origin.x, fValue.y + origin.y, -fValue.z + origin.z); //6
	vector3 point7(-fValue.x + origin.x, fValue.y + origin.y, -fValue.z + origin.z); //7
